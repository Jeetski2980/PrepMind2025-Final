      ...
      messages: [
        {
          role: "system",
          content:
            "You are an expert test prep tutor who creates high-quality practice questions for standardized tests. Always respond with valid JSON format.",
        },
        {
          role: "user",
          content: prompt,
    ...
    return questions.map((q: any, index: number) => ({
      ...
      correct_answer:
        typeof q.correct_answer === "number"
          ? Math.max(0, Math.min(3, q.correct_answer))
          : 0,
      ...
      messages: [
        {
          role: "system",
          content:
            "You are PrepMind's AI tutor - an expert in SAT, ACT, and AP test preparation. You provide clear, helpful, and encouraging guidance to students preparing for standardized tests. Always keep responses focused on educational content and test preparation.",
        },
        {
          role: "user",
          content: prompt,
...
function generateFallbackQuestions(
  ...
  if (subject.toLowerCase().includes("math")) {
    questions.push(
      {
        ...
        correct_answer: 0,
        explanation:
          "To solve 3x + 7 = 22, subtract 7 from both sides: 3x = 15. Then divide both sides by 3: x = 5.",
        difficulty: "Easy",
      },
      {
        id: 2,
        ...
        correct_answer: 0,
        explanation:
          "Using the slope formula: m = (y₂ - y₁)/(x₂ - x₁) = (13 - 5)/(6 - 2) = 8/4 = 2.",
        difficulty: "Medium",
      },
      {
        id: 3,
    ...
    questions.push(
      {
        ...
        correct_answer: 0,
        explanation:
          "'Deliberate' in most reading contexts means intentional or purposeful, suggesting something done on purpose rather than by accident.",
        difficulty: "Medium",
      },
      {
        id: 2,
        ...
        correct_answer: 2,
        explanation:
          "Reading comprehension questions often test your ability to identify the main purpose. Look for the central argument or theme.",
        difficulty: "Medium",
      },
    );
    ...
    questions.push({
      id: 1,
      question:
        "According to the data in the graph, what happens to enzyme activity as temperature increases from 20°C to 40°C?",
      choices: [
      ...
      correct_answer: 3,
      explanation:
        "Enzyme activity typically increases with temperature up to an optimal point, so from 20°C to 40°C, activity would generally increase steadily before reaching the optimal temperature.",
      difficulty: "Medium",
    });
  } else if (
    ...
    questions.push({
      ...
      correct_answer: 0,
      explanation:
        "A comma splice occurs when two independent clauses are joined only by a comma. Option A incorrectly uses just a comma to connect two complete thoughts.",
      difficulty: "Medium",
    });
  }
