          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <Card className="bg-white dark:bg-black border dark:border-white/20 hover:shadow-lg dark:hover:border-emerald-400/50 transition-all duration-300">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 dark:text-white/70">
                  PrepMind is a modern web application built with
                  professional-grade tools including a React frontend and
                  Node.js backend. It's crafted to be a stable, fast, and
            ...
            <Card className="bg-white dark:bg-black border dark:border-white/20 hover:shadow-lg dark:hover:border-emerald-400/50 transition-all duration-300">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 dark:text-white/70">
                  Our goal is to deliver a secure, responsive, and accessible
                  platform for students of all backgrounds. We believe powerful
                  study tools should be the same opportunities to succeed as
                  anyone else.
                </p>
              </CardContent>
            </Card>
          ...
          <Card className="bg-white dark:bg-black border dark:border-white/20">
            <CardContent className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Frontend Technology */}
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-emerald-400 mb-4">
                    Frontend Technology
                  </h3>
          ...
          <div className="text-center mt-12">
            <div className="bg-gradient-to-r from-emerald-600 to-green-600 dark:from-emerald-600 dark:to-green-600 text-white p-8 rounded-2xl">
              ...
              <p className="text-emerald-100 mb-6">
                Join thousands of students using PrepMind to achieve their test
                prep goals.
              </p>
