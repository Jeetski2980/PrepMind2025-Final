      ...
      <div className="min-h-screen bg-gray-50 dark:bg-black flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-white/70 mb-8 max-w-md mx-auto">
            Oops! The page you're looking for doesn't exist. Let's get you back to studying with PrepMind.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/practice">
              <Button variant="outline" className="dark:bg-black dark:border-white/50 dark:text-white dark:hover:bg-white dark:hover:text-black">
                Start Practicing
              </Button>
            </Link>
          </div>
