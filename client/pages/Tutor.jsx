...
const AppleTouchIcon = () => (
  <div
    style={{ width: "60px", height: "60px" }} // You can adjust size here
    dangerouslySetInnerHTML={{
      __html: `
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
             xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
             viewBox="0 0 158 156" xml:space="preserve">
          <!-- ✅ Paste your full <path> elements here exactly as-is -->
          <path fill="#15A858" opacity="1.000000" stroke="none"
                d="M103.000000,157.000000 C89.645775,157.000000 76.291542,157.000000 ... z"/>
          <path fill="#12B372" opacity="1.000000" stroke="none"
                d="M1.000000,99.000000 C1.000000,89.979103 ... z"/>
          <!-- ...etc -->
        </svg>
      `,
    }}
