    ...
    <Alert className="mb-6 bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800">
      ...
      <AlertDescription className="text-green-700 dark:text-green-400">
        <div className="space-y-2">
          <p>
            ✅ PrepMind is now powered by Together AI's advanced language models
            for high-quality test prep content.
          </p>
          <div className="text-sm bg-green-100 dark:bg-green-800/30 p-3 rounded-md">
            <p className="font-medium mb-1">Features:</p>
            <ul className="list-disc list-inside space-y-1">
              <li>
                AI-generated practice questions for SAT, ACT, and AP exams
              </li>
          ...
          <p className="text-xs">
            Together AI provides fast, reliable, and cost-effective AI
            capabilities.
          </p>
        </div>
      </AlertDescription>
